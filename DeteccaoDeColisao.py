...
        #check if 'as corners are insede b
...
    #draw the blank background onto the surface
...
        #bouncer has moved past the leftside
        if bouncer['dir'] ==DOWNLEFT:
            bouncer['dir'] = DOWNRIGHT
        if bouncer['dir'] == UPLEFT:
            bouncer['dir'] = UPRIGHT
    if bouncer['rect'].right > WINDOWWIDTH:
        #bouncer has movedpast the right side
        if bouncer['dir'] == DOWNRIGHT:
            bouncer['dir'] = DOWNLEFT
        if bouncer['dir'] == UPRIGHT:
            bouncer['dir'] = UPLEFT
...
    # check if the bouncer has intersecteds with any food squares.
    for food in foods[:]:
